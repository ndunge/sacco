...
const createNext = context => opts => {
  ...
  if (opts.path.indexOf('http') !== 0 && ('/sacco/frontend/web/portal/' !== '/' && opts.path.indexOf('/sacco/frontend/web/portal/') !== 0)) {
    opts.path = urlJoin('/sacco/frontend/web/portal/', opts.path)
  }
  // Avoid loop redirect
