      ...
      <ul style="">
        <li style="font-size: .88rem;" class="flexc"> 
          ...
          <div style="font-weight: normal" class="fieldvalue">  
              <Input v-model="profile.name"   size="small" v-bind:disabled="mode === 'readonly'" ></Input>
          </div>
        </li>
        <li style="font-size: .88rem;" class="flexc"> 
          <div> Member No. </div>
          <div style="font-weight: normal" class="fieldvalue">  
              <Input v-model="profile.number" size="small" v-bind:disabled="mode === 'readonly'" ></Input>
          </div>
        </li>
        <li style="font-size: .88rem;" class="flexc">
          <div> Member Email </div>
          <div style="font-weight: normal" class="fieldvalue"> 
              <Input v-model="profile.email" size="small" v-bind:disabled="mode === 'readonly'" ></Input>
          </div>
        </li>
        <li style="font-size: .88rem;" class="flexc">
          <div> Phone Number </div>
          <div style="font-weight: normal" class="fieldvalue"> 
           <strong> <Input v-model="profile.phone" size="small" v-bind:disabled="mode === 'readonly'" ></Input></strong>
          </div>
        </li>
      </ul>
