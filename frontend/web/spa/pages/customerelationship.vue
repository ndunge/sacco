<template>
  <div id="signup-page"> 
    <div  id="signup-page-content">
      ...
      <div style="padding: 0">
        <h3 style="padding: .5rem; text-align: center">Kencom SACCO</h3>
        ...
        <p style="padding: .5rem; text-align: center; background: #ffffff">
          <img style="width: 200px" src="https://localhost:8090/sacco/frontend/web/images/kcb-logo.jpg">
        </p> 
...
export default {
  ...
  methods: { 
    handleSubmit(name) {
      const endpoint = 'https://localhost:8090/sacco/frontend/web/site/register'  
