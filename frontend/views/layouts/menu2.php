...
<div class="app-bar brown" data-role="appbar">
	<div class="container">
		<a class="app-bar-element branding">KSL</a>
                    <span class="app-bar-divider"></span>
		<ul class="app-bar-menu">
			<li data-flexorder="1" data-flexorderorigin="0"><a href="<?= $baseUrl; ?>/studentapplication">Home</a></li>
			<li data-flexorder="3" data-flexorderorigin="0"><a href="<?= $baseUrl; ?>//examregistration/transcript">Kencom Sacco</a></li>
		...
		<div class="app-bar-element place-right">
			...
			<ul class="d-menu place-right" data-role="dropdown">
				...
				<li><a href="<?php echo $baseUrl; ?>/student/update?id=<?=$StudentID;?>" style="padding-left:20px">Profile Details</a></li>
