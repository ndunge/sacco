...
<h4><b>Member Statistics</b></h4>
  ...
  <tr><th>Share Capital</th></tr>
            ...
            'Customer No_',
             ...
             [
              ...
              [
                ...
                'format' => 'raw',
                'value' => function ($dataProvider1)     {
                    $MemberNo = $dataProvider1['Customer No_'];
                     return Html::a('view detailed statement', "view?id=$MemberNo");
                 },
            ],
    ...
    <table border=0>
  <tr><th>Deposit Statement</th></tr>
</table>
    <?= GridView::widget([
        'dataProvider' => $summary4,
        'layout' => "\n{items}\n<div class='row'><div class='text-xs-left col-md-6'></div><div class='text-xs-right col-md-6'>{pager}</div></div>",
        'columns' => [
            ...
            'Customer No_',
             ...
             [
                ...
                'value' => function ($dataProvider1)     {
                    $MemberNo = $dataProvider1['Customer No_'];
                     return Html::a('view detailed statement', "deposit?id=$MemberNo");
                 },
            ],
     ...
     <table border=0>
  <tr><th>School fees savings</th></tr>
</table>
    <?= GridView::widget([
        'dataProvider' => $summary5,
        'layout' => "\n{items}\n<div class='row'><div class='text-xs-left col-md-6'></div><div class='text-xs-right col-md-6'>{pager}</div></div>",
        'columns' => [
            ...
            'Customer No_',
             ...
             [
                ...
                'value' => function ($dataProvider1)     {
                    $MemberNo = $dataProvider1['Customer No_'];
                     return Html::a('view detailed statement', "fees?id=$MemberNo");
                 },
            ],
    ...
    <table border=0>
  <tr><th>Children Savings</th></tr>
</table>
    <?= GridView::widget([
        'dataProvider' => $summary6,
        'layout' => "\n{items}\n<div class='row'><div class='text-xs-left col-md-6'></div><div class='text-xs-right col-md-6'>{pager}</div></div>",
        'columns' => [
            ...
            'Customer No_',
             ...
             [
                ...
                'value' => function ($dataProvider1)     {
                    $MemberNo = $dataProvider1['Customer No_'];
                     return Html::a('view detailed statement', "children?id=$MemberNo");
                 },
            ],
  ...
  <tr><th>Loan balances</th></tr>
        ...
        'columns' => [
            ...
            [
             ...
             [
                ...
                'value' => function ($dataProvider1)     {
                    $MemberNo = $dataProvider1['Customer No_'];
                     return Html::a('view detailed statement', "loanbalance?id=$MemberNo");
                 },
            ],
    ...
    <table border=0>
  <tr><th>Interest balances</th></tr>
</table>
    <?= GridView::widget([
        'dataProvider' => $summary2,
        'layout' => "\n{items}\n<div class='row'><div class='text-xs-left col-md-6'></div><div class='text-xs-right col-md-6'>{pager}</div></div>",
        'columns' => [
            ...
            [
                'header' => '<div style="text-align: right">Interest Balance</div>',
                'attribute' => 'Interest_Balance',
                'format' => ['decimal', 2],
                'contentOptions' => ['style' => 'text-align: right; width:10%']
            ],
             ...
             [
                ...
                'value' => function ($dataProvider1)     {
                    $MemberNo = $dataProvider1['Customer No_'];
                     return Html::a('view detailed statement', "interestbalance?id=$MemberNo");
                 },
            ],
