    ...
    <div class="pure-u-1 pure-u-md-1-3">
        <div id="message" style="color:#F00">
         ...
         <?php $form = ActiveForm::begin( [
            ...
            <button class="button large-button primary bg-hover-darkRed" type="button" onclick="validateThenRegister(event, this.form)">
			
                <h5 class="align-left">
                    <span class="mif-pencil place-left"></span>&nbsp;
                    <span class="text-shadow">Submit </span></h5>
            </button>
        </form>
    </div>