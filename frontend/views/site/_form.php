...
<?= Html::beginForm(['site/create']) ?>
	...
	<tr>
		  <td width="50%">
			...
			<div class="input-control text full-size">                   	
				<input name="No_" type="text"  id="No_"  value="APP<?= $nextContactNo ?>" readonly>          
			</div>
		</td>
	...
	<tr>
		<td>
			...
			<div data-role="select"> 
				<select name="Employed"  id="Employes" class="input-control full-size" >
					<option value="0" selected="selected"></option>
					<?php 
	...
	<tr>
		...
		<td>
			...
			<div class="input-control text full-size">                   	
				<input name="Bank Code" type="text" id="Bank Code"   >          
			</div>
		</td>
	...
	<tr>
		...
		<td>
			...
			<div class="input-control text full-size">                   	
				<input name="Bank Branch Code" type="text" id="Bank Branch Code" >          
			</div>
		</td>
