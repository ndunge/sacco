...
use Yii;
use common\models\Loansecurities;
 ...
 */
class LoansecuritiesController extends Controller
{
    /**
     * @inheritdoc
     */
         ...
         $company='Sacco].[dbo].[TRAINED DB$';
                ...
                $sql=" SELECT B.[Loan Number],
                           ...
                           A.[Type],
                            ...
                            where C.[Posting Type] between 1 and 2 AND  C.[Customer No_]=B.[Client Code]
                            and C.[Product Code]=A.[Loan No_]
                            
                            ) as oustanding_balance
                           

                           FROM [".$company."MC Loan Securities] A
                      join [".$company."Credits] B on B.[Loan Number]=A.[Loan No_] 
                      where B. [Loan Number]=A.[Loan No_] 
