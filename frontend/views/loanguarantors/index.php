...
<div class="loanapplications-index">
    ...
    <h3><b>Loans Guaranteed Report</b></h3>
        ...
        'columns' => [
            ...
            'Loan Number',
                ...
                'value' => function ($dataProvider)     {
                    ...
                    return ($dataProvider['Type'] == 1 ? 'Member' : 'Securities');
                 },
            ],
            'Security No_',
            'Name',
               ...
               [
                'header' => '<div style="text-align: right">Amount Committed</div>',
                'attribute' => 'Amount Committed',
                'format' => ['decimal', 2],
                ...
                'value' => function ($dataProvider)     {
                    ...
                    return ($dataProvider['Substituted'] == 0 ? 'False' : 'True');
                 },
            ],

                   [
                'header' => '<div style="text-align: right">Outstanding Balance</div>',
                'attribute' => 'oustanding_balance',
                'format' => ['decimal', 2],
                'contentOptions' => ['style' => 'text-align: right; width:10%']
            ],
