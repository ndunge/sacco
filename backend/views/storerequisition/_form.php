...
<div class="storerequisition-form">



<?= Html::beginForm(['storerequisition/create']) ?>
...
<tr>
        ...
        <td width="50%">
            ...
            <div class="input-control text full-size">                      
                <input name="No" style="background-color: #D3D3D3;"  type="text" id="RequisitionNo" value="STRQ<?=$nextstoreNo  ?>" readonly>          
            </div>
        </td>
        <td width="50%">
    ...
    <div class="pure-u-1"></div>
            <table class="table striped hovered" id="dataTables-1">
                ...
                <tr>
                    ...
                    <th class="text-left" width="10%">Quantity In Store</th>              
