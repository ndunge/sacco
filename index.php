...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav" style="background-color:#228B22;">
                ...
                <li><a href="/">ABOUT KENCOM SACCO</a></li>
  ...
  <!--  <h3>Add Booze Joint</h3> -->
    ...
    <div class="center">
      <h5 class="green"><strong>KCB SACCO</strong></h5>
      <img src="kcb-logo.jpg" height="200" width="206" border="1px">
    </div>
  ...
  <option>Category5</option>
     ...
     <div class="form-group">      
             <label name="subject">UserName</label>
             <input id="boozejointname" name="boozejointname" class="form-control">

       </div>
     
       <div class="form-group">      
             <label name="subject">Password</label>
             <input id="locationname" type="password" name="locationname" class="form-control">
